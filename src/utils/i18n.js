...
const translations = {
  es: {
    ...
    home: {
      greeting: 'Hola, {name}',
      heroTitle: 'Tu despensa', heroCaption: 'productos en seguimiento', heroEmpty: 'Aún no hay nada guardado',
    ...
    search: {
      placeholder: 'Buscar en tu despensa...', cancel: 'Cancelar', all: 'Todos', result: 'resultado', results: 'resultados', for: 'para',
    ...
    detail: {
      ...
      decrease: 'Reducir cantidad', increase: 'Aumentar cantidad',
    ...
    login: { title: 'Bienvenido de vuelta', registerTitle: 'Crea tu cuenta', subtitle: 'Inicia sesión para gestionar tu despensa', registerSubtitle: 'Crea tu cuenta y empieza a ahorrar', name: 'Nombre', namePlaceholder: 'Tu nombre', email: 'Correo electrónico', password: 'Contraseña', forgot: '¿Olvidaste tu contraseña?', submit: 'Iniciar sesión', register: 'Crear cuenta', newAccount: 'Crear cuenta nueva', haveAccount: 'Ya tengo cuenta', or: 'o', accept: 'Al continuar aceptas los', emailError: 'Ingresa un correo válido', passwordError: 'Mínimo 4 caracteres', nameError: 'Ingresa tu nombre', invalidCredentials: 'Correo o contraseña incorrectos', emailTaken: 'Ese correo ya tiene una cuenta', working: 'Un momento...' },
    common: { back: 'Volver', day: 'día', days: 'días', expired: 'Vencido', yesterday: 'Venció ayer', today: 'Vence hoy', tomorrow: 'Vence mañana', inDays: 'Vence en {count} días', agoDays: 'Venció hace {count} días', dash: '—', overdueBadge: '¡Ya!' },
    splash: { loading: 'Cargando...' },
  },
  en: {
    nav: { home: 'Home', categories: 'Categories', search: 'Search', alerts: 'Alerts', settings: 'Settings' },
    home: { greeting: 'Hello, {name}', heroTitle: 'Your pantry', heroCaption: 'products being tracked', heroEmpty: 'Nothing stored yet', expiring: '{count} {item} expiring this week', product: 'product', products: 'products', allPantry: 'All pantry', upcoming: 'Expiring soon', seeUpcoming: 'See upcoming', seeAll: 'See all ({count})', empty: 'Your pantry is empty. Add your first product with the + button', fresh: 'Nothing expiring this week. Everything is fresh!', noneInGroup: 'No products in this group.', order: 'Sort products', expiry: 'By expiry', name: 'By name', expired: 'Expired', urgent: 'Expiring soon', week: 'This week', later: 'Later', add: 'Add product' },
    ...
    login: { title: 'Welcome back', registerTitle: 'Create your account', subtitle: 'Sign in to manage your pantry', registerSubtitle: 'Create your account and start saving', name: 'Name', namePlaceholder: 'Your name', email: 'Email', password: 'Password', forgot: 'Forgot your password?', submit: 'Sign in', register: 'Create account', newAccount: 'Create new account', haveAccount: 'I already have an account', or: 'or', accept: 'By continuing you accept the', emailError: 'Enter a valid email', passwordError: 'At least 4 characters', nameError: 'Enter your name', invalidCredentials: 'Incorrect email or password', emailTaken: 'That email already has an account', working: 'One moment...' },
    common: { back: 'Back', day: 'day', days: 'days', expired: 'Expired', yesterday: 'Expired yesterday', today: 'Expires today', tomorrow: 'Expires tomorrow', inDays: 'Expires in {count} days', agoDays: 'Expired {count} days ago', dash: '—', overdueBadge: 'Now!' },
...
export function translateCategory(id, language) {
  ...
  const names = {
    lacteos: ['Lácteos', 'Dairy'], verduras: ['Verduras', 'Vegetables'], frutas: ['Frutas', 'Fruits'],
